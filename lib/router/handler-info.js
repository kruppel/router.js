import utils, { bind, merge, serialize, promiseLabel, applyHook } from './utils';
...
HandlerInfo.prototype = {
  ...
  resolve: function(shouldContinue, payload) {
    ...
    return utils.Promise.resolve(undefined, this.promiseLabel("Start handler"))
  ...
  runSharedModelHook: function(payload, hookName, args) {
    ...
    return utils.Promise.resolve(result, this.promiseLabel("Resolve value returned from one of the model hooks"));
  },
  ...
  checkForAbort: function(shouldContinue, promiseValue) {
    return utils.Promise.resolve(shouldContinue(), this.promiseLabel("Check for abort")).then(function() {
