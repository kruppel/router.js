...
import utils, { forEach, promiseLabel, callHook } from './utils';
...
TransitionState.prototype = {
  ...
  resolve: function(shouldContinue, payload) {
    ...
    return utils.Promise.resolve(null, this.promiseLabel("Start transition"))
    .then(resolveOneHandlerInfo, null, this.promiseLabel('Resolve handler'))['catch'](handleError, this.promiseLabel('Handle error'));

    function innerShouldContinue() {
      return utils.Promise.resolve(shouldContinue(), currentState.promiseLabel("Check if should continue"))['catch'](function(reason) {
