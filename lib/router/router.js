...
import utils, { trigger, log, slice, forEach, merge, serialize, extractQueryParams, getChangelist, promiseLabel, callHook } from './utils';
...
Object.defineProperty(Router, 'Promise', {
  get: function() {
...
function finalizeTransition(transition, newState) {
  ...
  try {
    ...
    if (transition.isAborted) {
      ...
      return utils.Promise.reject(logAbort(transition));
    }
